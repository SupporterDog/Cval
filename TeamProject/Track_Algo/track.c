...
void line_following(YB_Pcb_Car* car) {
    ...
    while (1) {
        ...
        case 0b1001:  // (H L L H) : ������ ����
            ...
            buffer = sensor_state;
            break;
        case 0b1101:  // (H H L H): (H L L H ) �ɶ����� ���ݾ� ��ȸ���ϱ�
        ...
        case 0b1000:  // (H L L L): ���� �� �ٸ� ��
            ...
            break;
        case 0b1110:  // (H H H L): (H H L H) �ɶ����� ���ݾ� ��ȸ���ϱ�
            ...
            break;
        case 0b1100:  // (H H L L): (H H L H) �ɶ����� ���ݾ� ��ȸ���ϱ�
            ...
            break;
        case 0b0111:  // (L H H H): (H L L H) �ɶ����� ���ݾ� ��ȸ���ϱ�
            ...
            break;
        case 0b0001:  // (L H H H): (H L L H) �ɶ����� ���ݾ� ��ȸ���ϱ�
        ...
        case 0b0011:  
            ...
            break;
        case 0b1011:  // (H L H H): (H L L H) �ɶ����� ���ݾ� ��ȸ���ϱ�
            ...
            break;
        case 0b1010:  // (H L H H): (H L L H) �ɶ����� ���ݾ� ��ȸ���ϱ�
            ...
            break;
        case 0b0101:  // (H L H H): (H L L H) �ɶ����� ���ݾ� ��ȸ���ϱ�
            ...
            break;
        case 0b0100:  // (H L H H): (H L L H) �ɶ����� ���ݾ� ��ȸ���ϱ�
            ...
            break;
        case 0b0010:  // (H L H H): (H L L H) �ɶ����� ���ݾ� ��ȸ���ϱ�
